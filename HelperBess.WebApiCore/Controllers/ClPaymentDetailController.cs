...
namespace HelperBess.WebApiCore.Controllers
{
    ...
    public class ClPaymentDetailController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("[action]")]
        [Route("api/ClPaymentDetail/GetClPaymentDetailParticipantId")]
        public IEnumerable<ClPaymentDetail> GetClPaymentDetailParticipantId(int participantid)
        {
            return ClPaymentDetailServiceService.GetClPaymentDetailParticipantId(participantid);
        }
    }
}
